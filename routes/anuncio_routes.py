...
@anuncio_bp.route("/api/anuncios", methods=["GET", "OPTIONS"])
...
@anuncio_bp.route("/api/anuncios/<int:id>", methods=["GET", "OPTIONS"])
...
@anuncio_bp.route("/api/anuncios", methods=["POST", "OPTIONS"])
...
@anuncio_bp.route("/api/anuncios/<int:id>", methods=["DELETE", "OPTIONS"])
